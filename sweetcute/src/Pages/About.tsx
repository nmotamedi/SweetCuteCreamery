export function About() {
  return (
    <div className="bg-[#7FBEF0] flex flex-col justify-center items-center">
      <h2 className="font-FaroVariable text-white text-2xl mt-10 text-center">
        HI
        <br />
        IM SARAH
      </h2>
      ...
      <h2 className="font-FaroVariable text-[#FEE38C] text-4xl -mt-8 mb-10 text-center">
        IS MY
        <br />
        ENTIRE PERSONALITY
      </h2>
      <div className="m-10">
        <p className="font-PoppinsBold text-white text-2xl mb-8">
        ...
        <p className="font-PoppinsBold text-white text-2xl mb-8">
          ...
          was spending all my time at my office job dreaming up what flavors Id
